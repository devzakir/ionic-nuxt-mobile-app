<template>
  <ion-list lines="none" class="p-0 app-menu bg-transparent mb-6">
    <ion-list-header>
      <h3 class="text-sm font-medium text-gray-600 mb-2 mt-0">Jobpilot</h3>
    </ion-list-header>
    <ion-item>
      <ion-nav-link
      ...
      >
        <ion-button expand="full" fill="clear" class="text-base text-gray-700">
    ...
    <ion-item>
      <ion-button expand="full" fill="clear" class="text-base text-gray-700">
        <div class="w-full flex items-center">
          ...
          <div class="ml-4 flex justify-between w-full items-center">
            <div>Call Now: <strong>(319) 555-0115</strong></div>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
