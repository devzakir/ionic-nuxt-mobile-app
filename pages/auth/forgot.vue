  ...
  <ion-page>
    ...
    <ion-content :scroll-y="false" class="">
      <div class="ion-content-scroll-host ion-padding px-6 py-8 bg-gray-50">
        <h3 class="mb-4 text-2xl font-semibold">Forget password</h3>
        <p class="flex items-center">
          Go back to
          <ion-button fill="clear" class="ml-2" href="/auth/login"
            >Sign In</ion-button
          >
        </p>
        <p class="flex items-center">
        ...
        <ion-item ref="item" class="email-input mb-2 rounded border mt-4">
          <ion-input
            type="email"
        ...
        <ion-button
          theme="primary"
          expand="block"
          class="rounded mt-4 text-base submit"
        >
          Reset Password
